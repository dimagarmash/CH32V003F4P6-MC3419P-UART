...
typedef enum
{
  MC34X9_RANGE_2G    = 0b0000,
  MC34X9_RANGE_4G    = 0b0001,
  MC34X9_RANGE_8G    = 0b0010,
  MC34X9_RANGE_16G   = 0b0011,
  MC34X9_RANGE_12G   = 0b0100,
  MC34X9_RANGE_END,
}   MC34X9_range_t;
...
/* general accel methods */
   ...
   volatile uint8_t start();//result like bool  bSpi like bool
    // Start measurement
    void wake();
    // End measurement
    void stop();
    ...
    void SetFIFOCtrl(MC34X9_fifo_ctl_t fifo_ctl,
                     ...
                     uint8_t fifo_thr);
    void SetMotionCtrl(uint8_t tilt_int_ctrl,
                       uint8_t flip_int_ctl,
                       uint8_t anym_int_ctl,
                       uint8_t shake_int_ctl,
                       uint8_t tilt_35_int_ctl);//tilt_int_ctrl,flip_int_ctl,anym_int_ctl,shake_int_ctl,tilt_35_int_ctl like bool
    void SetINTCtrl(uint8_t tilt_int_ctrl,
                    uint8_t flip_int_ctl,
                    uint8_t anym_int_ctl,
            uint8_t shake_int_ctl,
            uint8_t tilt_35_int_ctl);// all like a bool
    void SetFIFOINTCtrl(uint8_t fifo_empty_int_ctl,
                        uint8_t fifo_full_int_ctl,
                        uint8_t fifo_thr_int_ctl);//all like a bool
    ...
    uint8_t IsFIFOEmpty(void);//like a bool
...
// Bus function
uint8_t mcube_write_regs( uint8_t reg,uint8_t *value, uint8_t size);// bSpi like bool
uint8_t mcube_read_regs( uint8_t reg,uint8_t *value, uint8_t size);// bSpi like bool

uint8_t readRegister8(uint8_t reg);//bSpi like bool
void writeRegister8(uint8_t reg, uint8_t value);//bSpi like bool
